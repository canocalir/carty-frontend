...
class Signin extends React.Component {
  ...
  onSubmitSignIn = () => {
    fetch('https://enigmatic-spire-53847.herokuapp.com/signin', {
      method: 'post',
  ...
  <div className="measure">
    ...
    <div>
      ...
      className="b ph3 pv1 input-reset ba b--black shadow-5 bg-transparent dim pointer f6 dib" type="submit" value="Sign in"/>
    </div>
